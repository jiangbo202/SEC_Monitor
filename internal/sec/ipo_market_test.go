...
func TestParse424B4OfferingTableDriven(t *testing.T) {
	tests := []struct {
		...
		{name: "extracts shares-price wording used by EDGAR tables", text: `Number of common stock shares offered by us 12,500,000. The initial public offering price of the shares is $14.40 per share.`, wantOK: true, wantPrice: "14.40", wantShares: 12500000, wantGross: "180000000.00", wantType: "initial"},
