...
func New(deps Dependencies) (*gin.Engine, error) {
	...
	api := r.Group("/api")
	{
		...
		api.GET("/price-action-cycle/transitions", app.ListPriceActionCycleTransitions)
		api.GET("/price-action-cycle/tickers/:ticker/timeline", app.GetPriceActionCycleTimeline)
		api.GET("/price-action-cycle/effectiveness", app.GetPriceActionCycleEffectiveness)
		api.POST("/price-action-cycle/replay", app.ReplayPriceActionCycleHistory)
		api.GET("/price-action-cycle/config", app.GetPriceActionCycleConfig)
		api.PUT("/price-action-cycle/config", app.UpdatePriceActionCycleConfig)
		api.POST("/price-action-cycle/config/rollback", app.RollbackPriceActionCycleConfig)
		api.GET("/price-action-cycle/shadow-comparison", app.GetPriceActionCycleShadowComparison)
		api.GET("/price-action-cycle/health", app.GetPriceActionCycleHealth)
		...
		api.GET("/discovery/candidates/technical-history-recovery-queue", app.ListDiscoveryTechnicalHistoryRecoveryQueue)
		api.POST("/discovery/candidates/:ticker/technical-history-retry", app.RetryDiscoveryTechnicalHistoryTicker)
		...
		api.POST("/discovery/candidates/effectiveness/refresh", app.RefreshDiscoveryCandidateEffectiveness)
		api.POST("/discovery/candidates/effectiveness/replay", app.ReplayDiscoveryCandidateEffectiveness)
		...
		api.GET("/discovery/research-action-gate", app.GetDiscoveryResearchActionGate)
		...
		api.GET("/discovery/research-trade-ledger", app.ListResearchTradeLedger)
		api.POST("/discovery/research-trade-decisions", app.CreateResearchTradeDecision)
		api.POST("/discovery/research-trade-executions", app.CreateResearchTradeExecution)
		...
		api.GET("/insider-trading-plans", app.ListInsiderTradingPlans)
		api.GET("/insider-trading-plans/tickers", app.GetInsiderTradingPlanTickers)
		api.POST("/insider-trading-plans/backfill", app.BackfillInsiderTradingPlans)
		...
		api.GET("/research-theses", app.ListDueResearchTheses)
		api.GET("/research-theses/:ticker", app.GetResearchThesis)
		api.GET("/research-theses/:ticker/sources", app.ListThesisSources)
		api.PUT("/research-theses/:ticker", app.SaveResearchThesis)
