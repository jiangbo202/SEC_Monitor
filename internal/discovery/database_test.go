...
func TestMigrateCreatesDiscoveryTables(t *testing.T) {
	...
	tables := []struct {
		...
		{name: "eps_forecast_snapshots", model: &EPSForecastSnapshot{}},
		{name: "market_anomaly_snapshots", model: &MarketAnomalySnapshot{}},
		{name: "institutional_holder_snapshots", model: &InstitutionalHolderSnapshot{}},
		{name: "fund_holder_snapshots", model: &FundHolderSnapshot{}},
		{name: "longbridge_valuation_snapshots", model: &LongbridgeValuationSnapshot{}},
