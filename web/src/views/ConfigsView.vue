...
const inAppNotificationForm = reactive({
  ...
  candidate_technical_signal_enabled: true,
	price_action_cycle_enabled: true,
...
const notificationChannelRows: NotificationChannelRow[] = [
  ...
  { menu: '价格周期', key: 'price_action_cycle_enabled', legacyKey: 'price_action_cycle_enabled', label: '阶段变化', description: '当前候选或监控标的进入新的价格行为阶段时发送站内消息', inAppOnly: true },
