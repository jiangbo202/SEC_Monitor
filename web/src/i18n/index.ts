  ...
  'zh-CN': {
    ...
    pages: {
      ...
      targets: {
        ...
        fundIdentityModified: 'CIK、Series ID 或 Class ID 已与最近解析的基金身份不一致。请恢复匹配字段，或重新查询并确认候选。',
  ...
  'en-US': {
    ...
    pages: {
      ...
      targets: {
        ...
        fundIdentityModified: 'The CIK, Series ID, or Class ID differs from the most recently resolved fund identity. Restore the matching values or look up and confirm a candidate again.',
