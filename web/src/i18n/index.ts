  ...
  'zh-CN': {
    ...
    pages: {
      ...
      targets: {
        ...
        fundIdentityUnresolvedDetail: '不会自动监控整个 Trust。ETF 必须填写完整 Series ID 和 Class ID 才能保存；后端会拒绝不完整的身份。',
  ...
  'en-US': {
    ...
    pages: {
      ...
      targets: {
        ...
        fundIdentityUnresolvedDetail: 'The whole Trust will not be monitored automatically. An ETF must have complete Series ID and Class ID before it can be saved; the backend rejects incomplete identities.',
