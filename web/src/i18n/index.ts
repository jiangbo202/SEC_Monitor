  ...
  'zh-CN': {
    ...
    pages: {
      ...
      configs: {
        ...
        discoveryDatasourceHint: '系统会优先使用这里保存的配置；Provider 选择自动时继续使用环境变量规则。有 token 时会自动走 Tiingo。',
        ipoRadar: 'IPO监控',
        ipoEnabled: '启用 IPO监控',
        ipoFormTypes: '申报类型',
  ...
  'en-US': {
    ...
    pages: {
      ...
      configs: {
        ...
        tiingoBaseUrl: 'Tiingo Base URL',
        discoveryDatasourceHint: 'Saved settings here override runtime environment. Auto keeps the environment-based rule and uses Tiingo when a token is configured.',
        ipoRadar: 'IPO Monitor',
