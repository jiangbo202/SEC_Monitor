...
- IPO监控：扫描 SEC 当前申报流中的 S-1、F-1、S-1MEF 等 IPO/融资相关申请；发现公司后按 CIK 补齐 S-1/F-1、修订稿、EFFECT、424B、撤回类文件；支持申报列表、公司视图、详情抽屉、判断依据、手动状态校准，并按公司聚合标注新申报、更新中、已生效、已定价、已上市、撤回和长期无更新等状态。
